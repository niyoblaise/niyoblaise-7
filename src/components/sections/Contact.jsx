            ...
            <div className="px-4 w-150">
                ...
                <form className="space-y-6" onSubmit={handleSubmit}>
                    <div className="relative">
                        ...
                        "w-full bg-white/5 border-white/10 rounded px-4 py-3 text-white transition focus:border-blue-500 focus:bg-blue-500/5"
                     ...
                     <div className="relative">
                        ...
                        "w-full bg-white/5 border-white/10 rounded px-4 py-3 text-white transition focus:border-blue-500 focus:bg-blue-500/5"
                        placeholder="Your Email ✉️  eg. test@email.com"
